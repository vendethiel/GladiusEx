...
function Gladius:OnInitialize()
   ...
   self.dbi = LibStub("AceDB-3.0"):New("GladiusExDB", self.defaults)
	...
	self.testing = setmetatable({
      ...
      ["party2"] = { health = 30000, maxHealth = 32000, power = 10000, maxPower = 12000, powerType = 2, unitClass = "HUNTER", unitRace = "Night Elf", unitSpec = "Marksmanship" },
      ["party3"] = { health = 24000, maxHealth = 35000, power = 90, maxPower = 120, powerType = 3, unitClass = "ROGUE", unitRace = "Human", unitSpec = "Combat" },
      ["party4"] = { health = 20000, maxHealth = 40000, power = 80, maxPower = 130, powerType = 6, unitClass = "DEATHKNIGHT", unitRace = "Dwarf", unitSpec = "Unholy" },
      ["party5"] = { health = 10000, maxHealth = 30000, power = 10, maxPower = 100, powerType = 1, unitClass = "WARRIOR", unitRace = "Gnome", unitSpec = "Arms" },
...
function Gladius:UpdateUnitSpecialization(unitid, specID)
   ...
   self.buttons[unitid].specID = specID > 0 and specID or nil
